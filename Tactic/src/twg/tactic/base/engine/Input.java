...
public class Input {
	...
	public static final int KEY_FULLSTOP          = 0x34; /* . on main keyboard */
	...
	public static void update() {
		...
		for(int i = 0; i < NUM_KEYCODES; i++) if(getKey(i)) lastKeys.add(i);
		
		lastMouse.clear();
		
		for(int i = 0; i < NUM_MOUSEBUTTONS; i++) if(getMouse(i)) lastMouse.add(i);
	}
